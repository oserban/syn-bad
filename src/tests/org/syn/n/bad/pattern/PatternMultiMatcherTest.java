 ...
 * @version 1/6/13
 */
public class PatternMultiMatcherTest {
    private Matcher matcher;

    @Before()
    public void setup() {
        matcher = new Matcher();
        matcher.addMatcher(new PatternMatcher("un", "xxx yyy zzz"));
        matcher.addMatcher(new PatternMatcher("un", "xxx yyy"));
        matcher.addMatcher(new PatternMatcher("unt-t", "xxx aaa zzz"));
    }
    ...
    public void testSimpleMatcher1() {
        ...
        assertSame("un", result.getTemplateID());
        ...
        result = matcher.match(tokens, 0, tokens.size());
        assertSame("unt-t", result.getTemplateID());
    }
}
